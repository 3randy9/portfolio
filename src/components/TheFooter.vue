<template>
  <footer class="text-grey-darkest text-sm p-6">
    <ul>
      ...
      <li>
        <a href="https://github.com/3randy9" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
      ...
      <li>
        <a href="https://soundcloud.com/randy_39/" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
    ...
    <small>&copy;{{setToday}} randy39 All Rights Reserved.</small>
  </footer>
</template>
